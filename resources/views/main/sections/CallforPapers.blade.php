            ...
            <div class="col-lg-10">
                ...
                <div class="pdf-viewer-wrapper shadow-lg rounded overflow-hidden bg-light border">
                    ...
                    <div id="pdf-fallback" class="p-4 text-center" style="display: none;">
                        ...
                        <a href="{{ asset('documents/CfP_PDF.pdf') }}" target="_blank" class="btn btn-lg btn-primary rounded-pill px-4">
...
{{--                    <a href="{{ asset('documents/CfP_PDF.pdf') }}" download class="btn btn-outline-primary m-2">--}}
{{--                        <i class="fa fa-download mr-1"></i> Download PDF--}}
{{--                    </a>--}}
                    <a href="{{ asset('documents/Call for Papers with References.docx') }}" download class="btn btn-outline-secondary m-2">
...
@push('script')
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            const url = "{{ asset('documents/CfP_PDF.pdf') }}";
